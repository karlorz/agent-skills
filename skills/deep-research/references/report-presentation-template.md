# Report Presentation Template — deep-research

This is the source of truth for deep-research report presentation and
its source ledger. deep-research composes every normal report from this
bundled template. The template is language-adaptive and applies to every
research topic. Both entrypoints implement this contract.

## Bundled default

- **deep-research defaults to the bundled template** at
...
`skills/deep-research/scripts/lint-report.py` validates the generated
