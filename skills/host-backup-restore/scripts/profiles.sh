...
declare -A PRESET_GROUPS=(
  [full]="base ssh tailscale caddy_domains hermes databases other_services apt wiki"
...
declare -A PRESET_DESCRIPTION=(
  [full]="All 9 groups — full infrastructure backup including SSH identity and Tailscale state"
