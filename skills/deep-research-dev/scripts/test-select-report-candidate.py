...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="test-select-report-") as temp:
        ...
        cand_path.write_text(valid_report_text("Candidate Clean"), encoding="utf-8")
        ...
        assert out_path.read_text(encoding="utf-8") == cand_path.read_text(encoding="utf-8")
        ...
        sel = json.loads(sel_path.read_text(encoding="utf-8"))
        assert sel["selected"] is None or sel["selected"] == "failed"
