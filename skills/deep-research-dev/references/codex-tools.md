# Codex Tool Mapping — deep-research-dev

deep-research-dev is written with Claude Code tool names. When running under
OpenAI Codex CLI or the Codex App, map them to your platform equivalents.
This file is the deep-research-dev analogue of Superpowers'
`using-superpowers/references/codex-tools.md`.

## Tool Mapping

| deep-research-dev references | Codex equivalent |
|---|---|
...
deep-research-dev's cost model pins each agent to a tier: research/fetch/refine
...
deep-research-dev output is filesystem work — writing a query page, `--save <path>`,
raw captures. That is safe inside a Codex sandbox. deep-research-dev does NOT push
